...
const GENRE_GROUPS = [
  ...
  ["Dance & Electronic", [
    ...
    ["Downtempo / Trip-Hop", ["deepHouse","aeolian","jazz"]],
    ["IDM", ["lydian","deepHouse","dorian"]],
    ["Lo-Fi / Chillhop", ["jazz","deepHouse","doowop"]],
    ["Hip-Hop", ["deepHouse","aeolian","jazz"]],
    ["Trap", ["axisMinor","festival","aeolian"]],
  ]],
  ["Latin", [
    ["Latin", ["montuno","andalusian","jazz"]],
    ["Salsa", ["montuno","jazz","andalusian"]],
    ["Son Cubano", ["montuno","jazz","andalusian"]],
    ["Mambo", ["montuno","jazz","mixo"]],
    ["Cha-Cha-Chá", ["montuno","jazz","axis"]],
    ["Rumba", ["andalusian","montuno","jazz"]],
    ["Timba", ["montuno","jazz","andalusian"]],
    ["Latin Jazz", ["jazz","montuno","andalusian"]],
    ["Samba", ["jazz","montuno","axis"]],
    ["Bossa Nova (Latin)", ["jazz","montuno","axis"]],
    ["Bachata", ["axis","doowop","montuno"]],
    ["Merengue", ["montuno","three","axis"]],
    ["Cumbia", ["axis","three","montuno"]],
    ["Reggaetón", ["axisMinor","festival","montuno"]],
    ["Latin Pop", ["axis","edm","axisMinor"]],
    ["Tango", ["andalusian","montuno","phrygian"]],
    ["Bolero", ["jazz","doowop","andalusian"]],
    ["Mariachi", ["three","axis","andalusian"]],
    ["Norteño", ["three","axis","doowop"]],
    ["Forró", ["three","mixo","montuno"]],
  ]],
  ["World & Modal", [
