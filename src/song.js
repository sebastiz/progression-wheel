...
function makeSong(s) {
  return {
    ...
    perc: s.perc, secPerc: s.secPerc, pad: s.pad, secPad: s.secPad, secMove: s.secMove, secTrans: s.secTrans, secBeat: packBeats(s.secBeat), secNar: s.secNar, delayId: s.delayId, grid: s.grid,
