...
function makeSong(s) {
  return {
    ...
    secBassBeat: packBeats(s.secBassBeat), secPercBeat: packBeats(s.secPercBeat), secMove: s.secMove, secTrans: s.secTrans, secBeat: packBeats(s.secBeat), secNar: s.secNar, delayId: s.delayId, grid: s.grid,
